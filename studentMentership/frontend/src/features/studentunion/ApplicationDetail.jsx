...
function ApplicationDetail() {
        ...
        {[...Array(10)].map((_, i) => (
          <div
            ...
            className={`w-3 h-3 rounded-full ${
              i < score ? "bg-purple-600" : "bg-gray-300"
            }`}
          />
        ))}
      </div>
  ...
  return (
    <div className="p-8 pt-30 bg-white max-w-7xl mx-auto rounded-lg shadow-xl font-sans">
      <div className="grid min-h-screen grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="col-span-1 border-l border-gray-200 pl-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-6">{goals}</p>
          </div>

          {/* Experience */}
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-3">Experience</h3>
            <p className="text-gray-600 mb-6">{experience}</p>
          </div>
        </div>
