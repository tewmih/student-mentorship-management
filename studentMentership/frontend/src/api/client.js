...
export const profileAPI = {
  ...
  updateSettings: (settings) => api('/api/profile/settings', {
    method: 'PUT',
    data: settings,
  }),
};
...
export const menteeAPI = {
  ...
  submitPetition: (data) => api('/api/mentee/petition', {
    method: 'POST',
    data,
  }),
  submitFeedback: (sessionId, feedback) => api(`/api/mentee/session/${sessionId}/feedback`, {
    method: 'POST',
    data: feedback,
  }),
};
...
export const mentorAPI = {
  submitApplication: (data) => api('/api/mentor/application', {
    method: 'POST',
    data,
  }),
  getMentees: () => api('/api/mentor/mentees'),
  createSession: (data) => api('/api/mentor/sessions', {
    method: 'POST',
    data,
  }),
  getSessions: () => api('/api/mentor/sessions'),
  uploadResource: (sessionId, data) => api(`/api/mentor/session/${sessionId}/resources`, {
    method: 'POST',
    data,
  }),
};
...
export const studentUnionAPI = {
  ...
  assignMentor: (data) => api('/api/student-union/assign-mentor', {
    method: 'POST',
    data,
  }),
  getPetitions: () => api('/api/student-union/petitions'),
  resolvePetition: (petitionId, data) => api(`/api/student-union/petitions/${petitionId}/resolve`, {
    method: 'POST',
    data,
  }),
...
export const adminAPI = {
  ...
  assignUnion: (userId) => api(`/api/admin/assign-union/${userId}`, {
    method: 'POST',
  }),
...
export const taskAPI = {
  createTask: (data) => api('/api/tasks', {
    method: 'POST',
    data,
  }),
  getTasks: () => api('/api/tasks'),
  getTasksByMentee: (menteeId) => api(`/api/tasks/mentee/${menteeId}`),
  updateTask: (taskId, data) => api(`/api/tasks/${taskId}`, {
    method: 'PUT',
    data,
  }),
  deleteTask: (taskId) => api(`/api/tasks/${taskId}`, {
    method: 'DELETE',
  }),
  updateTaskStatus: (taskId, status) => api(`/api/tasks/${taskId}/status`, {
    method: 'PATCH',
    data: { status },
  }),
  requestCompletion: (taskId) => api(`/api/tasks/${taskId}/request-completion`, {
    method: 'POST',
  }),
};
...
export const sessionAPI = {
  createSession: (data) => api('/api/sessions', {
    method: 'POST',
    data,
  }),
  getSessions: () => api('/api/sessions'),
  getSessionById: (sessionId) => api(`/api/sessions/${sessionId}`),
  updateSession: (sessionId, data) => api(`/api/sessions/${sessionId}`, {
    method: 'PUT',
    data,
  }),
  deleteSession: (sessionId) => api(`/api/sessions/${sessionId}`, {
    method: 'DELETE',
  }),
};
...
export const attendanceAPI = {
  markAttendance: (sessionId, data) => api(`/api/attendance/session/${sessionId}`, {
    method: 'POST',
    data,
  }),
  getAttendance: (sessionId) => api(`/api/attendance/session/${sessionId}`),
  getStudentAttendance: (studentId) => api(`/api/attendance/student/${studentId}`),
};

// ==================== MESSAGE API ====================
export const messageAPI = {
  getMessages: (roomId) => api(`/api/messages/room/${roomId}`),
  sendMessage: (data) => api('/api/messages', {
    method: 'POST',
    data,
  }),
...
export const notificationAPI = {
  ...
  markAsRead: (notificationId) => api(`/api/notifications/${notificationId}/read`, {
    method: 'PATCH',
  }),
  markAllAsRead: () => api('/api/notifications/read-all', {
    method: 'PATCH',
  }),
  updatePreferences: (preferences) => api('/api/notifications/preferences', {
    method: 'PUT',
    data: preferences,
  }),
};
