const Footer = () => {
  return (
      <footer className="bg-background text-foreground h-60 border-t border-border py-8 mt-auto">
      <div className="container flex flex-col md:flex-row justify-between items-center md:items-start gap-8 text-sm">
        ...
        {/* Copyright */}
        <div className="text-muted-foreground text-foreground text-center md:text-right">
