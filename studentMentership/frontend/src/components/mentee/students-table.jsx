    ...
    <Card className="bg-white border-[#e7e7e7]">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-[#464255]">{title}</CardTitle>
            {subtitle && (
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-[#737373]">
              ...
              <div className="relative">
                <select
                  className={`${
                    effectiveSort ? "border-[#2d9cdb]" : "border-[#e7e7e7]"
                  } appearance-none pr-8 rounded px-2 py-1 text-[#464255] outline-none focus:outline-none focus:ring-2 focus:ring-[#2d9cdb]`}
                ...
                <ChevronDown
                  className={`w-4 h-4 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none ${
                    effectiveSort ? "text-[#2d9cdb]" : "text-[#737373]"
                  }`}
                />
              </div>
