...
function ChatButtons() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-start py-4 px-2 bg-[#f7fafd] rounded-xl min-h-[400px]">
      <div className="w-full flex flex-col gap-8 mt-4">
        ...
        <div className="w-full flex justify-center">
          ...
          >
            <span className="flex items-center justify-center w-10 h-10 rounded-full bg-[#e8faf3]">
              {/* Simple computer/monitor icon (SVG) */}
              <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                <rect x="3" y="4" width="18" height="13" rx="2" fill="#34d399"/>
                <rect x="3" y="4" width="18" height="13" rx="2" fill="#e8faf3"/>
            ...
            <span className="font-semibold text-[15px] text-gray-900">Group chat</span>
          </button>
        </div>
        ...
        <div className="w-full flex justify-center">
          ...
          >
            ...
            <span className="font-semibold text-[15px] text-gray-900">Individual chat</span>
          </button>
        </div>
      </div>
    </div>
