...
const mentor = {
  name: "Samantha",
  image:
    "https://randomuser.me/api/portraits/women/44.jpg", // Replace with actual image if needed
  intro:
...
function MentorSidebar() {
  return (
    <div className="bg-white rounded-xl p-4 w-full min-h-[400px] shadow-sm flex flex-col gap-2 text-[13px]">
      ...
      <div className="border rounded-lg flex items-center justify-between px-3 py-2 mb-2">
        <span className="text-gray-700 text-sm">Hello, <span className="font-medium">{mentor.name}</span></span>
        <img
          src={mentor.image}
          alt={mentor.name}
      ...
      <div className="text-[13px] text-gray-800 mb-4" style={{lineHeight: "1.2"}}>
        {mentor.intro}
      </div>
